...
INSERT INTO person(first_name, last_name, dob) VALUES ('Child 1', 'Nielson', '2009-01-01'), ('Child 2', 'Nielson', '2010-05-01'), ('Child 3', 'Nielson', '2010-06-01'), ('Parent 1', 'Nielson', '1980-01-01')
...
INSERT INTO relationship(child, parent) VALUES ((select id FROM person WHERE first_name = 'Child 3'), (select id FROM person WHERE first_name = 'Parent 2'));
